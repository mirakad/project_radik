...
def moscow():
    try:
        ...
        canvas.create_text(250,520,text="Москва",fill="red",font="Arial 34 bold" )
        i=0
        while i<60:
            i=i+1
...
def london():
    try:
        ...
        canvas.create_oval(10,10,490,490,fill="orange")
        canvas.create_text(250,225,text=".",font="Arial 62")
        canvas.create_text(250,520,text="Лондон",fill="red",font="Arial 34 bold")
        i=0
        while i<60:
            i=i+1
            canvas.create_line(250+210*cos(-i*6*pi/180+pi/2),250-210*sin(-6*i*pi/180+pi/2),250+190*cos(-6*i*pi/180+pi/2),250-190*sin(-6*i*pi/180+pi/2),width=2)
...
def tokyo():
    try:
        ...
        canvas.create_oval(10,10,490,490,fill="orange")
        canvas.create_text(250,225,text=".",font="Arial 62")
        canvas.create_text(250,520,text="Токио",fill="red",font="Arial 34 bold")
        i=0
        while i<60:
            i=i+1
            canvas.create_line(250+210*cos(-i*6*pi/180+pi/2),250-210*sin(-6*i*pi/180+pi/2),250+190*cos(-6*i*pi/180+pi/2),250-190*sin(-6*i*pi/180+pi/2),width=2)
...
def paris():
    try:
        ...
        canvas.create_oval(10,10,490,490,fill="orange")
        canvas.create_text(250,225,text=".",font="Arial 62")
        canvas.create_text(250,520,text="Париж",fill="red",font="Arial 34 bold")
        i=0
        while i<60:
            i=i+1
            canvas.create_line(250+210*cos(-i*6*pi/180+pi/2),250-210*sin(-6*i*pi/180+pi/2),250+190*cos(-6*i*pi/180+pi/2),250-190*sin(-6*i*pi/180+pi/2),width=2)
...
def new_york():
    try:
        ...
        canvas.create_oval(10,10,490,490,fill="orange")
        canvas.create_text(250,225,text=".",font="Arial 62")
        canvas.create_text(250,520,text="Нью-Йорк",fill="red",font="Arial 34 bold")
        i=0
        while i<60:
            i=i+1
            canvas.create_line(250+210*cos(-i*6*pi/180+pi/2),250-210*sin(-6*i*pi/180+pi/2),250+190*cos(-6*i*pi/180+pi/2),250-190*sin(-6*i*pi/180+pi/2),width=2)
